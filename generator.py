data = {
    ...
    "aff-units": 4,
    "avg-burden-pct": "87.5%",
    "tracts": [{"id": "0100023023423", "city": "Coronado", "state": "California", "population": "10334.0",
    ...
    <section class="break-before">
      ...
      <div class="text-lg mt-2">
        ...
        <div class="inline-block align-top">
          ...
          <b>DAC Status:</b> <mark class="{tract['dac-mark']}">{tract['dac-mark']}</mark></br>
...
<body class="w-screen">
    ...
    <div class="w-full px-14">
      ...
      <div class="h-[500px] bg-gray-300 pt-[240px]">
        <p>MAP GOES HERE</p>
      </div>
    ...
    <section class="break-before">
      <div class="h-8 w-full">&nbsp;</div>
      <div class="font-bold text-xl text-white bg-[#00583C] p-2 w-80">Census Tract 0100023023423</div>
      <div class="text-lg mt-2">
        <div class="inline-block align-top mr-8">
          <b>City:</b> Coronado</br>
          <b>County:</b> San Diego County</br>
        ...
        <div class="inline-block align-top">
          <b>QCT Status:</b> <mark class="bad">Eligible</mark></br>
          <b>DAC Status:</b> <mark class="bad">Disadvantaged</mark></br>
          <b>State Percentage:</b> <mark class="bad">90%</mark> </br>
          <b>National Percentage:</b> <mark class="good">40%</mark> </br>
        </div>
      </p>
...
pdfkit.from_string(html, "out.pdf", options=options, css="templates/simple-styles.css")